...
/**
 * ### Configuration of an stack chart
 * @name stack_config
 */
...
var stack_config = new ChartConfig({
	displayName: "Stack Chart",
	parser: require("./parse-stack"),
	calculateDimensions: require("./stack-dimensions"),
	display: display,
	defaultProps: defaultProps
});

module.exports = stack_config;
